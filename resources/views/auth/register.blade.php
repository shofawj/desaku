                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="form-login">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="group-password">
                                        <input id="password-confirm" placeholder="Type your confirm password"
                                            type="password" class="" name="password_confirmation" required>
                                    ...
                                    <div class="group-google">
                                        <button id="customBtn" type="button" class="btn customGPlusSignIn">
                                            ...
                                            <span class="buttonText">Daftar dengan Google</span>
                                        </button>
                                    </div>
                                    ...
                                    <div class="group-facebook">
                                        <button id="customBtnFacebook" type="button" class="btn customGPlusSignIn">
                                            <span class="icon"></span>
                                            <span class="buttonText">Daftar dengan Facebook</span>
                                        </button>
