    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="kt-portlet">
          ...
          <form class="kt-form kt-form--label-right" action="{{route('seller.penduduk.update',[$penduduk->id])}}" method="POST">
            ...
            <div class="kt-portlet__body">
              <div class="form-group row">
                <div class="col-lg-12">
                  ...
                  <input type="text" name="nama" id="nama" class="form-control" value="{{$penduduk->nama}}">
                  <span class="form-text text-muted">Tolong masukkan nama lengkap penduduk</span>
                </div>
                <div class="col-lg-12">
                  <label class="">Alamat:</label>
                  <textarea type="text" class="form-control" name="alamat" id="alamat" placeholder="Masukkan alamat penduduk">{{$penduduk->alamat}}</textarea>
              ...
              <div class="form-group row">
                <div class="col-lg-12">
                  ...
                  <div class="kt-input-icon">
                    <input type="number" name="no_hp" id="no_hp" class="form-control" value="{{$penduduk->no_hp}}">
